...
class ManualEntry(APIView):
    ...
    def post(self, request, format=None):
        ...
        return Response({'message':f'{success} Late entry registered entered {len(st_no_list) - success} failed.'}, status=status.HTTP_201_CREATED)
